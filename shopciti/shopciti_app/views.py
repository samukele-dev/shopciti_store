...
def register_store(request):
    if request.method == 'POST':
        store_name = request.POST['store_name']  # Updated field name to 'name'
        ...
        try:
            ...
            new_store.save()
            # You should replace 'Store' with your actual model name
    ...
    # Render the registration form page if it's a GET request
    return render(request, 'shopciti_app/registration.html')
