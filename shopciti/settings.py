"""
Django settings for shopciti project.
...
SECRET_KEY = 'django-insecure-pqsh%1t*kd6g94hi45tt+lpr2zzkz9#x&ob(z^n$ddkapa_5&x'
...
WSGI_APPLICATION = 'shopciti.wsgi.application'
...
# Add this setting to specify the directory where collected static files will be stored
